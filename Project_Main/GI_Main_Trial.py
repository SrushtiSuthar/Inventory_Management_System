...
class BillWindow(QWidget):
    ...
    def setup_ui(self):
        ...
        sales = {"Name" : self.user_data[0], "Phone no." : self.user_data[1], "Purchase" : self.item_data, "Total bill" : float(self.item_data['Price']) * int(self.item_data['Quantity'])}
    ...
    def update_inventory(self):
        ...
        with open("Grocery Sales.json", "w"):
